...
class weightedLoss(nn.Module):
    def __init__(self):
        ...
        self.crossentropy = nn.CrossEntropyLoss(weight=torch.Tensor([0.8, 1.1260713329, 1.116669019, 4.3366425512, 4.3308459881]).cuda(),reduction="none") #[0.0684208353, 0.0213502735, 0.1260713329, 0.116669019, 0.3366425512, 0.3308459881]
